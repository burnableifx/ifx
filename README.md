...
and integration into `burn` remain separate work. The
[edition 0.2 authoring MVP](docs/language-next.md) adds functions, structs,
constructors, explicit returns, TOML root inputs and cross-file editor navigation.
Its application, fleet and lifecycle examples are executable offline.
